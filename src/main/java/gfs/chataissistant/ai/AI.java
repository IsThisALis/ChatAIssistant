...
public class AI implements AiService { 
  ...
  public void update() {
    ...
    @Override
  public String ask(gfs.chataissistant.twitch.chat.Message message) {
    ...
    if (config.apiProvider.equals("deepseek")) {
      //request = HttpRequest.newBuilder()
      // TODO: DeepSeek API support
    }

    if (config.apiProvider.toLowerCase().equals("lms")) {
      request = HttpRequest.newBuilder()
    ...
    if (config.apiProvider.toLowerCase().equals("openrouter")) {
      request = HttpRequest.newBuilder()
